    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.id_save_view:
                ...
                carfault.setCarNum(idCarNumText.getText().toString());
                carfault.setCarMessage(MYmessage);


                if (carId.equals("false"))
                    car.save(this, new SaveListener() {
                        @Override
                        public void onSuccess() {
                            ToastUtils.toast(BindCarActivity.this, "保存成功");
                            myPushMessage();
                        ...
                        public void onFailure(int i, String s) {
                            ToastUtils.toast(BindCarActivity.this, "保存失败");
                        }
                    });
                car.update(this, carId, new UpdateListener() {
                    ...
                    public void onFailure(int code, String msg) {
                        // TODO Auto-generated method stub
                        ToastUtils.toast(BindCarActivity.this, "保存失败g");
                    }
                });
            ...
            case R.id.id_scan_code_view:
                ...
                Intent startScan = new Intent(BindCarActivity.this, CaptureActivity.class);
//				startActivity(startScan);
            ...
            case R.id.id_edit_view:
                ...
                Intent eintent = new Intent(BindCarActivity.this, EditCarActivity.class);
                if (result != null && result.split("，").length == 13) {
                    eintent.putExtra("information", result);
                    eintent.putExtra("InstallationId",InstallationId);
